...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Transaction::AiConfidence)
                            .decimal_len(5, 2)
                            .null(),
                    )
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Asset::TickerSymbol)
                            .string_len(20)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(Asset::AssetType)
                            .enumeration(
                                ...
                                ["Stock", "Crypto", "Mutual Fund", "Commodity", "Fiat"],
                            )
                            .not_null(),
                    )
                    .col(ColumnDef::new(Asset::Name).string_len(100).not_null())
                    .col(
                        ColumnDef::new(Asset::CurrentPrice)
                            .decimal_len(15, 2)
                            .not_null()
                            .default(0.0),
                    )
                    ...
                    .col(
                        ColumnDef::new(Asset::LastUpdate)
                            .timestamp()
                            .default(Expr::current_timestamp()),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(InvestmentTransaction::UserId)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(InvestmentTransaction::AssetId)
                            .integer()
                            .not_null(),
                    )
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Portfolio::Quantity)
                            .decimal_len(15, 4)
                            .not_null()
                            .default(0.0),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Insight::InsightType)
                            .string_len(50)
                            .not_null(),
                    )
                    .col(ColumnDef::new(Insight::Message).text().not_null())
                    .col(
                        ColumnDef::new(Insight::IsRead)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .drop_table(Table::drop().table(Insight::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(Portfolio::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(InvestmentTransaction::Table).to_owned())
            .await?;
        manager

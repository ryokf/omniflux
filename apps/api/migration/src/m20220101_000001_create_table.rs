    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                .table(User::Table)
                .if_not_exists()
                .col(ColumnDef::new(User::Id).string_len(36).not_null().primary_key())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Wallet::UserId).string_len(36).not_null())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Transaction::UserId).string_len(36).not_null())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(InvestmentTransaction::UserId).string_len(36).not_null())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Portfolio::UserId).string_len(36).not_null())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(Insight::UserId).string_len(36).not_null())
